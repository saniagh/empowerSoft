...
import Content from '../components/ContentEntry/Content'
import ReadProductsComponent from '../components/ContentEntry/ReadProductsComponent'
'use strict';
...
//entry for the content page
ReactDOM.render(
    <Router history={browserHistory}>
        <Route path="/content.php" component={Content}>
